...
import static pdf.pdftool.util.Constants.THEME_BLACK;
import static pdf.pdftool.util.Constants.THEME_DARK;
import static pdf.pdftool.util.Constants.THEME_WHITE;
